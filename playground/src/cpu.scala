...
class cpu extends Module {
  ...
  val clear_exu = Wire(Bool())

  // ifu
  ifu.io.in.addr := pc

  // ifu_idu
  ifu_idu.io.valid            := (clear_ifu && (!clear_exu))
  ...
  // idu_exu
  idu_exu.io.valid                  := (ifu_idu.io.valid_out && (!clear_exu))
  ...
  // exu_mem
  exu_mem.io.valid                  := (idu_exu.io.valid_out && (!clear_exu))
  ...
  exu_mem.io.idu_contr_in.reg_write := idu_exu.io.idu_contr_out.reg_write && idu_exu.io.valid_out
  exu_mem.io.idu_contr_in.hi_write  := idu_exu.io.idu_contr_out.hi_write && idu_exu.io.valid_out
  exu_mem.io.idu_contr_in.lo_write  := idu_exu.io.idu_contr_out.lo_write && idu_exu.io.valid_out
  exu_mem.io.idu_contr_in.hi_read   := idu_exu.io.idu_contr_out.hi_read  
  exu_mem.io.idu_contr_in.lo_read   := idu_exu.io.idu_contr_out.lo_read   
  exu_mem.io.idu_contr_in.hilo_src  := idu_exu.io.idu_contr_out.hilo_src  
  exu_mem.io.idu_contr_in.mem_read  := idu_exu.io.idu_contr_out.mem_read && idu_exu.io.valid_out
  exu_mem.io.idu_contr_in.mem_write := idu_exu.io.idu_contr_out.mem_write && idu_exu.io.valid_out
  exu_mem.io.idu_contr_in.mem_mask  := idu_exu.io.idu_contr_out.mem_mask  
  exu_mem.io.idu_contr_in.branch    := idu_exu.io.idu_contr_out.branch && idu_exu.io.valid_out  
  exu_mem.io.idu_contr_in.cmp_op    := idu_exu.io.idu_contr_out.cmp_op    
  exu_mem.io.idu_contr_in.jump      := idu_exu.io.idu_contr_out.jump && idu_exu.io.valid_out
  exu_mem.io.idu_contr_in.jsrc      := idu_exu.io.idu_contr_out.jsrc
  exu_mem.io.idu_contr_in.call_src  := idu_exu.io.idu_contr_out.call_src  
  exu_mem.io.idu_contr_in.signed    := idu_exu.io.idu_contr_out.signed    
  exu_mem.io.idu_contr_in.cp0_read  := idu_exu.io.idu_contr_out.cp0_read  
  exu_mem.io.idu_contr_in.cp0_write := idu_exu.io.idu_contr_out.cp0_write && idu_exu.io.valid_out
  ...
  branch.io.in.branch_exu := idu_exu.io.idu_contr_out.branch
  branch.io.in.branch_mem := mem_reg.io.idu_contr_out.branch
  branch.io.in.bcmp       := exu.io.out.cmp
  branch.io.in.jump       := idu_exu.io.idu_contr_out.jump
  branch.io.in.jsrc       := idu_exu.io.idu_contr_out.jsrc
  ...
  clear_ifu := ((pc + 4.U) =/= branch.io.out.pc) //TODO
  clear_exu := (((idu.io.out.rs === idu_exu.io.idu_data_out.rd) && idu_exu.io.valid_out) || 
                ((idu.io.out.rs === exu_mem.io.idu_data_out.rd) && exu_mem.io.valid_out) || 
                ((idu.io.out.rt === idu_exu.io.idu_data_out.rd) && idu_exu.io.valid_out) || 
                ((idu.io.out.rt === exu_mem.io.idu_data_out.rd) && exu_mem.io.valid_out) ||
                ((idu.io.contr.hi_read && exu_mem.io.idu_contr_out.hi_write) && exu_mem.io.valid_out) ||
                ((idu.io.contr.hi_read && idu_exu.io.idu_contr_out.hi_write) && idu_exu.io.valid_out) ||
                ((idu.io.contr.lo_read && exu_mem.io.idu_contr_out.lo_write) && exu_mem.io.valid_out) ||
                ((idu.io.contr.lo_read && idu_exu.io.idu_contr_out.lo_write) && idu_exu.io.valid_out)) && idu_exu.io.valid_out
  // next pc
  pc := Mux(clear_exu, ifu_idu.io.ifu_data_out.pc, branch.io.out.pc)
}
